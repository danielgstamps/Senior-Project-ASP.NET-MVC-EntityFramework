...
namespace CapstoneProject.EvaluationMigrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CapstoneProject.DAL.EvaluationContext>
    {
        ...
        protected override void Seed(DAL.EvaluationContext context)
        {
            ...
            {
                new Employee {EmployeeID = 1, FirstName = "John", LastName = "Adams", CohortID = 1, Address = "5509 Barker Pl, Lanham, MD, 20706", Email = "johnadams@gmail.com", Phone = "678-444-5531", ManagerID = 1, SupervisorID = 1, Evaluations = new List<Evaluation>()},
                new Employee {EmployeeID = 2, FirstName = "Stanley", LastName = "Johnson", CohortID = 1, Address = "1925 Pleasant Ave, Saint Charles, IL, 60174", Email = "stanleyjohnson@gmail.com", Phone = "678-555-5531", ManagerID = 2, SupervisorID = 2, Evaluations = new List<Evaluation>()},
                new Employee {EmployeeID = 3, FirstName = "Ryan", LastName = "Anderson", CohortID = 2, Address = "1101 Charter Oak Ct., IL, 56869", Email = "ryananderson@gmail.com", Phone = "678-567-5678", ManagerID = 2, SupervisorID = 2, Evaluations = new List<Evaluation>()},
                new Employee {EmployeeID = 4, FirstName = "Curtis", LastName = "Russell", CohortID = 2, Address = "5253 Trophy Dr, Fairfield, CA, 94534", Email = "curtisrussell@gmail.com", Phone = "678-888-9977", ManagerID = 1, SupervisorID = 1, Evaluations = new List<Evaluation>()},
                new Employee {EmployeeID = 5, FirstName = "Phillip", LastName = "Davis", CohortID = 3, Address = "3805 Jadewood Drive North Chicago, IL 60064", Email = "PhillipGDavis@rhyta.com", Phone = "224-399-9854", ManagerID = 2, SupervisorID = 2, Evaluations = new List<Evaluation>()},
                new Employee {EmployeeID = 6, FirstName = "Don", LastName = "Harmon", CohortID = 3, Address = "4031 Frum Street Smithville, TN 37166", Email = "DonSHarmon@rhyta.com", Phone = "615-273-2077", ManagerID = 2, SupervisorID = 2, Evaluations = new List<Evaluation>()},
            ...
            {
                new Evaluation {EvaluationID = 1, EmployeeID = 1, Stage = "1", Categories = new List<Category>()},
                new Evaluation {EvaluationID = 2, EmployeeID = 2, Stage = "2", Categories = new List<Category>()},
                new Evaluation {EvaluationID = 3, EmployeeID = 3, Stage = "3", Categories = new List<Category>()},
                new Evaluation {EvaluationID = 4, EmployeeID = 4, Stage = "4", Categories = new List<Category>()},
                new Evaluation {EvaluationID = 5, EmployeeID = 5, Stage = "5", Categories = new List<Category>()},
                new Evaluation {EvaluationID = 6, EmployeeID = 6, Stage = "6", Categories = new List<Category>()},
